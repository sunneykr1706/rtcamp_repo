...
//echo $txet['products'][8]['tags'];
	...
	{
        //echo $k;
       // $linkop="https://winesubscribe12.myshopify.com/products/".products[0].handle;
        if( $txet['products'][$k]['tags'] == $emaila)
             {
                 //echo "</br>";
                 $ans=$k+1;
                 $ch++;
                 $linkop="https://winesubscribe12.myshopify.com/products/".$txet['products'][$k]['handle'];
                 //echo $emaila;
                 //echo "</br>";
                // echo  $txet['products'][$k]['tags'] ;
                 echo "</br>";
                 echo "<a href='$linkop'>Product is </a>".$ans." </br> "."selected choices are".$emaila;
                 echo "</br>";
             }
        $k++;
    }
    ...
    {
        $ans=8;
        $linkop="https://winesubscribe12.myshopify.com/products/".$txet['products'][$ans]['handle'];
        echo "</br>";
